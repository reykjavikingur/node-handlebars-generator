...
var AssetDirectory = require('./asset-directory');
...
constructor.prototype = {
	create: create,
	registerAssetDirectory: registerAssetDirectory,
...
function registerAssetDirectory(srcPath, options) {
	this.assetDirectories.push(new AssetDirectory(srcPath, options));
}
...
function generatePages(distPath, options, callback) {
	...
	var assetPromise = AssetDirectory.saveAll(distPath, this.assetDirectories);
